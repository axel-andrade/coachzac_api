...
function Player(request, response) {
    ...
    var _super = {
        ...
        publicMethods: {
            ...
            editPlayerProfileImage: function() {
                  //Somente usuário logados 
                  if (!_currentUser) {
                    _response.error(Messages.error.ERROR_UNAUTHORIZED);
                    return;
                ...
                var requiredFields = utils.verifyRequiredFields(_params, ["playerId", "profileImage"]);
            ...
            getPlayerById: function () {
                ...
                return _super.getPlayerById(_params.playerId).then(function (response) {
                    ...
                    _response.success(utils.formatObjectToJson(response, ["name", "email", "dateOfBirth", "weight", "height", "adress", "phone", "profileImage", "level","points","badFundaments","mediumFundaments","goodFundaments","lastAnalyze","favorited"]));
            ...
            getPlayers: function () {
                ...
                return query.find().then(function (results) {
                    ...
                    for (var i = 0; i < results.length; i++) {
                        ...
                        data.push(utils.formatObjectToJson(results[i],["name", "email", "dateOfBirth", "weight", "height", "adress", "phone", "profileImage", "level","points","badFundaments","mediumFundaments","goodFundaments","lastAnalyze","favorited"]));
                    }
            ...
            getFavoritePlayers: function () {
                ...
                return query.find().then(function (result) {
                    ...
                    for (var i = 0; i < result.length; i++) {
                        ...
                        data.push(utils.formatObjectToJson(result[i], ["name", "email", "dateOfBirth", "weight", "height", "adress", "phone", "profileImage", "level","points","badFundaments","mediumFundaments","goodFundaments","lastAnalyze", "favorited"]));
                    }
                    _response.success(data);
